		...
		<div class="page-content" style="margin:0;padding:0;height:auto;">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<table id="sample-table" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								<th>${s.employ.name}</th>
								<th>${s.type==2?"进货":"销售"}</th>
								<th>${s.count}</th>
								<th>${s.seller_price}</th>
								<th>${s.totalPrice}</th>
				...
				<span>第 ${pager.pageNum } 页&nbsp;&nbsp;&nbsp;共 
						...
						&nbsp;&nbsp;&nbsp;
						<!-- 首页 -->
						<span><a href="RecordAction_tolist2?pageNum=1"><i class="icon-double-angle-left bigger-150"></i></a></span>
						&nbsp;&nbsp;&nbsp;
						<!-- 上一页 -->
						<c:choose>
							<c:when test="${pager.pageNum>1}">
								<span><a href="RecordAction_tolist2?pageNum=${pager.pageNum-1}"><i class="icon-angle-left bigger-150"></i></a></span>
							</c:when>
							<c:otherwise>
						...
						<c:choose>
							<c:when test="${pager.pageNum<pager.totalPage}">
								<span><a href="RecordAction_tolist2?pageNum=${pager.pageNum+1}"><i class="icon-angle-right bigger-150"></i></a></span>
							</c:when>
							<c:otherwise>
						...
						<!-- 末页 -->
						&nbsp;&nbsp;&nbsp;
						<span><a href="RecordAction_tolist2?pageNum=${pager.totalPage}"><i class="icon-double-angle-right bigger-150"></i></a></span>
						&nbsp;&nbsp;&nbsp;
						<!-- 选择页面跳转 -->
